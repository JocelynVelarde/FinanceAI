...
st.divider()
st.markdown("<span style='margin-left: 110px; font-weight: 20px; font-size: 40px'>We have multiple amazing features for administrators and users.</span>", unsafe_allow_html=True)
